...
import { ArrowRight, AlertCircle, CheckCircle, Zap, Eye, EyeOff } from "lucide-react";
      ...
      {success ? (
        <div className="text-center">
          <div className="mb-6 p-4 rounded-xl bg-emerald-50 text-emerald-600 dark:bg-emerald-500/10 dark:text-emerald-400 flex flex-col items-center gap-3 font-semibold text-sm animate-in fade-in zoom-in duration-500">
            ...
            Akun Anda berhasil diaktifkan! Anda sekarang dapat masuk menggunakan kata sandi yang baru Anda buat.
          </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div className="mb-6 p-4 rounded-xl bg-blue-50 text-blue-600 dark:bg-blue-500/10 dark:text-blue-400 font-semibold text-sm text-center">
            Silakan buat kata sandi untuk akun Anda sebelum mulai menggunakan layanan.
          </div>
          <div>
            <label className="block text-sm font-bold text-slate-700 dark:text-slate-300 mb-2">Buat Kata Sandi</label>
      ...
      <div className="max-w-md w-full bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl rounded-[2rem] shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:shadow-[0_8px_30px_rgb(0,0,0,0.2)] overflow-hidden border border-slate-200/60 dark:border-slate-800/60">
        <div className="p-10 text-center relative overflow-hidden pb-6">
          ...
          <div className="relative z-10">
            ...
            <h1 className="text-2xl font-extrabold text-slate-900 dark:text-white tracking-tight mb-2">Aktivasi Akun</h1>
            <p className="text-slate-500 dark:text-slate-400 font-medium text-sm">Selamat datang di Smart Power BMS.</p>
          </div>
        </div>
